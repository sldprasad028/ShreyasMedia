...
const Footer = () => {
  return (
    <div className='flex flex-col bg-[#212529] px-6 xl:px-20 py-6 '>
      ...
      <div className='grid grid-cols-4  gap-3 xl:gap-32'>
           {/* 1st */}
                  ...
                  <div className='w-full '>
                    <div className='flex flex-col gap-0'>
                      ...
                      <div className="relative flex justify-center">
                        <p className="text-white text-[10px] absolute top-2 right-[40%]">News</p>
            ...
            {/* 2nd */}
            <div className='flex flex-col gap-4 text-[#F8F9FA] xl:pl-0 pl-9'>
            ...
            <div className='flex flex-col gap-3  text-[#F8F9FA]'>
              ...
              <h1 className='font-[inter]'>Get the latest updates straight to your inbox</h1>
              <input className='p-2 border border-white rounded-lg' placeholder='Enter your email' />
              {/* Submit Button */}
              <button className='px-5 py-3 bg-[#E11A68] rounded-lg font-[inter]'>
                  Subscribe
              </button>
              ...
              <div className='flex xl:gap-4 gap-2'>
                  <a href="https://play.google.com/store/games?device=windows" target="_blank" rel="noopener noreferrer"
                      className='xl:px-4 px-3 py-2 flex items-center gap-2 border border-white rounded-lg cursor-pointer'>
                      ...
                      <h1 className='xl:text-sm text-[12px] font-[inter]'>Google Play</h1>
                    </a>
                    <a href="https://www.apple.com/in/app-store/" target="_blank" rel="noopener noreferrer"
                          className=' xl:px-3 px-2 py-2 flex items-center gap-2 border border-white rounded-lg cursor-pointer'>
                        ...
                        <h1 className='xl:text-sm text-[12px] font-[inter]'>App Store</h1>
                    </a>
              </div>
            </div>
      ...
      {/* Second Section */}
      <hr className='mt-6 border border-slate-800'/>
      {/* 3rd Section */}
      <div className='px-20 py-6 flex justify-between'>
          <h1 className='font-[inter] text-[#FFF] text-xs'>© 2025 Shreyas Media. All rights reserved</h1>
          <h1 className='font-[inter] text-[#FFF] text-xs'>Privacy Policy | Sitemap</h1>
      </div>
